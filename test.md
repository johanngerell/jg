...
<hr>
<p>title:  C++ Codegen Differences Between MSVC, Clang and GCC</p>
<p>published:  false</p>
<p>description:  C++ Codegen Differences Between MSVC, Clang and GCC</p>
<p>tags:  cpp, compiler, optimization, assembly</p>
<p>//cover_image:  https://direct_url_to_image.jpg</p>
<hr>
...
<ul>
<li>
<p><a href="#msvc-codegen">MSVC Codegen</a></p>
</li>
<li>
<p><a href="#clang-codegen">Clang Codegen</a></p>
</li>
<li>
<p><a href="#gcc-codegen">GCC Codegen</a></p>
</li>
<li>
...
<ul>
<li><a href="#example-2-class-with-member-function-and-data">Example 2: Class With Member Function and Data</a></li>
</ul>
<ul>
...
<span class="token keyword">static</span>  <span class="token keyword">int</span> <span class="token function">random_int</span><span class="token punctuation">(</span><span class="token keyword">int</span>  max_value<span class="token punctuation">)</span>
...
<p>|--------------------------|----------------|</p>
<p>| x64 msvc v19.28 (VS16.9) | /O2 /std:c++17 |</p>
<pre class=" language-nasm"><code class="prism  language-nasm">
push <span class="token register variable">rbx</span> <span class="token comment">; save old rbx on the stack since it's</span>
...
<p>| Compiler | Options |</p>
<p>|---------------------|----------------|</p>
<p>| x86-64 clang 11.0.1 | -O3 -std=c++17 |</p>
<pre class=" language-nasm"><code class="prism  language-nasm">
...
<p>| Compiler | Options |</p>
<p>|-----------------|----------------|</p>
<p>| x86-64 gcc 10.2 | -O3 -std=c++17 |</p>
<pre class=" language-nasm"><code class="prism  language-nasm">
push <span class="token register variable">rbx</span>
...
<pre class=" language-c"><code class="prism ++ language-c">
<span class="token keyword">struct</span>  random_gen
...
<pre class=" language-c"><code class="prism ++ language-c">
<span class="token keyword">int</span> <span class="token function">random_user</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<p>Again, “Godbolting” this simple example will give very similar output for all three compared compilers:</p>
<p>[Compiler Explorer - Class With Member Function and Data]</p>
<p>(<a href="https://godbolt.org/z/8f3qWEzn5">https://godbolt.org/z/8f3qWEzn5</a>)</p>
...
<pre class=" language-c"><code class="prism ++ language-c">
<span class="token keyword">int</span>  random_gen<span class="token punctuation">:</span><span class="token punctuation">:</span><span class="token function">random_int</span><span class="token punctuation">(</span><span class="token punctuation">)</span>  <span class="token keyword">const</span>
...
<p>for which the assembly is</p>
<pre class=" language-nasm"><code class="prism  language-nasm">
sub <span class="token register variable">rsp</span>, <span class="token number">56</span> <span class="token comment">; increase the stack size by the</span>
...
<p>---------------|------|------</p>
<p>stack top - 56 | | 44 bytes “shadow space” and alignment</p>
<p>. | . | .</p>
<p>stack top - 8 | 4711 | gen.max_value</p>
<p>stack top - 4 | 0 | gen.unused2</p>
<p>stack top | 0 | gen.unused1</p>
<p>The stack grows “downwards” (towards lower memory addresses).</p>
