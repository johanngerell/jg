...
/// one cpp file defines JG_TEST_MAIN. By placing the `test_adder` at global scope, it will be instantiated,
/// and add the test suites in its constructor, before `main()` is called. The `main()` that is generated
/// when JG_TEST_MAIN is defined will execute all added test suites.
/// @example
///     // flubber_tests.cpp
///     #include <jg_test.h>
///     #include "flubber.h"
